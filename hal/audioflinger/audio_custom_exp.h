...
*****************************************************************/
#define DEVICE_MAX_VOLUME       (0)
#define DEVICE_VOICE_MAX_VOLUME (0)
#define DEVICE_AMP_MAX_VOLUME   (0)
#define DEVICE_MIN_VOLUME       (-9)
#define DEVICE_VOICE_MIN_VOLUME (-9)
#define DEVICE_AMP_MIN_VOLUME   (-9)
